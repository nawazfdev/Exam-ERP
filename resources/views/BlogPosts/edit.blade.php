...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('Edit Blog Post') }}</h1>
            </div>
                ...
                <div class="card">
                    <form action="{{ route('BlogPosts.update', $blogpost->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <label for="blogcategory_id">{{ __('Blog Category') }}</label>
                            <div class="input-group mb-3">
                                <select name="blogcategory_id" id="blogcategory_id"
                                    class="form-control @error('blogcategory_id') is-invalid @enderror" required>
                            ...
                            @if($blogpost->feature_image)
                                <img src="{{ asset('storage/' . $blogpost->feature_image) }}" alt="Feature Image"
                                    class="img-thumbnail" width="150">
                            @endif

                            <!-- Description Field with Summernote -->
                            <label for="description">{{ __('BlogPost Description') }}</label>
                            <div class="input-group mb-3">
