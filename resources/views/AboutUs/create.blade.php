...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('Create About Us') }}</h1>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="items">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="items[0][heading]" class="form-control" required>

                                    <label for="content">{{ __('Content') }}</label>
                                    <textarea name="items[0][content]" class="form-control summernote"
                                        required></textarea>
                                </div>
                            </div>
