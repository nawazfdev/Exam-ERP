                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="title" id="title"
                                    ...
                                    placeholder="{{ __('Enter Page Title') }}" value="{{ old('title', $page->title) }}"
                                    required>
                                @error('title')
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="slug" id="slug"
                                    ...
                                    placeholder="{{ __('Enter Page Slug') }}" value="{{ old('slug', $page->slug) }}"
                                    required>
                                @error('slug')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="input-group mb-3">
                                <textarea name="content" id="summernote" rows="5"
                                    ...
                                    placeholder="{{ __('Enter Page Content') }}" required>{{ old('content', $page->content) }}</textarea>
                                @error('content')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            @if($page->feature_image)
                                <div class="mb-3">
                                    ...
                                    <img src="{{ asset('storage/' . $page->feature_image) }}" alt="Feature Image"
